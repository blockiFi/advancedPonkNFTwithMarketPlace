...
contract shitPonk is ERC721 , Ownable {
    using SafeMath for uint256;
   using Counters for Counters.Counter;
   Counters.Counter private _ponkIDs;
   ...
   mapping (uint256 => ponk )  public shitPonks;
   ...
   constructor () ERC721("SHIT PONT NFT" , "SHITPONK"){}
    ...
    function addAttribute( uint256[] memory TotalCounts , string[] memory names) public onlyMinter{
        ...
        require(attributeCounter <= attributeCount, "Attribute Count Exceeded");
        require( (totalAddedFromAttribute + TotalCount) <= totalAttributeCombination, "Count would Exceed supply");
        require(!isSetAttribute[attributeCounter] ,"attribute ID already Added");
